...
esp_err_t esp_psram_extram_add_to_heap_allocator(void)
{
    ...
    uint32_t byte_aligned_caps[] = {MALLOC_CAP_SPIRAM, 0, MALLOC_CAP_8BIT | MALLOC_CAP_32BIT | MALLOC_CAP_SIMD};
    ...
    if (s_psram_ctx.regions_to_heap[PSRAM_MEM_32BIT_ALIGNED].size) {
        ...
        uint32_t word_aligned_caps[] = {MALLOC_CAP_SPIRAM, 0, MALLOC_CAP_32BIT};
